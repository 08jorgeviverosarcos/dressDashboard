# AGENTS.md — Project Constitution (InfoWorld / Dress Dashboard)

This document defines the **absolute rules** Codex must follow when working in this repository.
It is the single source of truth for architecture, conventions, and refactor constraints.

Codex must read and obey this file before making any changes.
...
Codex must STOP after each phase and summarize changes.

---

## 13. Execution Rules for Codex
...
If unsure, Codex must ASK before acting.
